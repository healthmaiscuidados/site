      ...
      <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <a href="#" className="text-2xl font-bold text-indigo-600">
            HomeCare <span className="text-teal-500">Premium</span>
          </a>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-xl font-bold mb-4 text-indigo-400">HomeCare Premium</h4>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">E-mail: contato@homecarepremium.com.br</p>
              <p className="text-gray-400 text-sm mt-1">Tel: (XX) XXXX-XXXX</p>
            </div>
          </div>
          
          <div className="mt-10 pt-6 border-t border-gray-800 text-center">
            <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} HomeCare Premium. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
